...
const Ships = () => {
  ...
  return (
    <div className="h-[87vh] w-[80vw] overflow-x-scroll max-h-[87vh]">
      ...
      {editShipOpen && (
        <Modal open={editShipOpen} onClose={() => setEditShipOpen(false)}>
          <EditShip
            setShips={setShips}
      ...
      {ships.length === 0 ? (
        <div className="text-center">No Ships to Display</div>
      ) : (
        <>
              ...
              {ships.map((item) => {
                return (
                  <ShipsRow
                    ...
                    item={item}
                    setShips={setShips}
                    setEditModalOpen={setEditShipOpen}
                    setShipToEdit={setShipToEdit}
                  />
                );
              })}
            </tbody>
